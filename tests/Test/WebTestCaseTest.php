...
EOF;
    ...
    public function testIndexFetchContent(): void
    {
        ...
        $this->assertContains(
            '<h1>AlexisLefebvreFixturesBundle</h1>',
            $content
        );
    }
...
EOF;
    ...
    {
        $fixtures = $this->loadFixtures([
            'AlexisLefebvre\FixturesBundle\Tests\App\DataFixtures\ORM\LoadUserData',
        ]);
        ...
        $users = $em->getRepository('AlexisLefebvreFixturesBundle:User')
            ->findAll();
        ...
        $user = $em->getRepository('AlexisLefebvreFixturesBundle:User')
            ->findOneBy([
                'id' => 1,
            ]);
    ...
    public function testAppendFixtures(): void
    {
        ...
        $this->loadFixtures(
            ['AlexisLefebvre\FixturesBundle\Tests\App\DataFixtures\ORM\LoadSecondUserData'],
            true
        );
    ...
    {
        $fixtures = $this->loadFixtures([
            'AlexisLefebvre\FixturesBundle\Tests\App\DataFixtures\ORM\LoadDependentUserWithServiceData',
        ]);
     ...
     *
     * @see https://github.com/liip/AlexisLefebvreFixturesBundle/issues/273
     */
