...
namespace AlexisLefebvre\FixturesBundle\Tests\DependencyInjection\Compiler;
...
class SetTestClientPassMockTest extends TestCase
{
    ...
    public function testSetTestClientPassElse(): void
    {
        ...
        try {
            ...
            $this->assertSame(
                'The AlexisLefebvreFixturesBundle\'s Query Counter can only be used in the test environment.'.
                PHP_EOL.
                'See https://github.com/liip/AlexisLefebvreFixturesBundle#only-in-test-environment',
                $e->getMessage()
            );
