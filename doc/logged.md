...
1. Use the `alexis_lefebvre_fixtures.authentication` key in the `config_test.yml` file;
...
[`config_test.yml`](https://github.com/liip/AlexisLefebvreFixturesBundle/blob/master/Tests/App/config.yml#L16)
file the key `name`:
